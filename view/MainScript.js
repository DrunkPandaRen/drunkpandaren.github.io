Aria.tplScriptDefinition({
    ...
    $prototype: {
        ...
        fail : function() {
            ...
            return "Ooooops！猫饼这一次在第 "+this.data.level+" 关停止了脚步，但是度过了 "+this.data.timer+"s 的home working时光呢.";
        },

        win : function() {
            clearInterval(this.interval);
            return "Wooohooo! 太酷了，亲爱的只用了 "+(this.MAXMOVES-this.data.level+1-this.data.moves)+" 次点击就清除了障碍! :)";
        }
